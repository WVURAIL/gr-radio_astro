...
# Generated: Tue Mar 26 15:23:00 2019
##################################################
...
class detect_with_sink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radio_astro_ra_event_sink_0 = radio_astro.ra_event_sink('Watch.not', vec_length, frequency, samp_rate, 1, 'Event Detection', observer, 'My Horn', '', 14., 0, 90)
...
def main(top_block_cls=detect_with_sink, options=None):
