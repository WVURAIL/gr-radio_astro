...
class vector_demo_complex_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "vector_demo_complex_2")
...
def main(top_block_cls=vector_demo_complex_2, options=None):
