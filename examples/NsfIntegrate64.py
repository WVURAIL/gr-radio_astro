...
# Generated: Mon Mar 16 13:38:04 2020
##################################################
...
class NsfIntegrate64(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=NsfIntegrate64, options=None):
