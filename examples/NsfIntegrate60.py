...
# Generated: Wed Jun 19 21:25:29 2019
##################################################
...
class NsfIntegrate60(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        [self.top_grid_layout.setRowStretch(r,1) for r in range(2,8)]
        [self.top_grid_layout.setColumnStretch(c,1) for c in range(2,10)]
