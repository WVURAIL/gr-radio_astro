...
class nsf_sdrplay_test_80(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_sdrplay_test_80")
...
def main(top_block_cls=nsf_sdrplay_test_80, options=None):
