...
# Generated: Fri Apr 12 09:17:04 2019
##################################################
...
class NsfIntegrate45(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._Gain1_tool_bar, 2, 7, 1, 2)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(7, 9):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_0_win, 3, 1, 6, 8)
        for r in range(3, 9):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 9):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_histogram_sink_x_0_win, 3, 0, 3, 1)
        for r in range(3, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.pluto_source_0 = iio.pluto_source('192.168.2.1', int(Frequency), int(Bandwidth), 20000000, 0x8000, False, False, False, "manual", float(Gain1), '', True)
    ...
    def set_Frequency(self, Frequency):
        ...
        self.pluto_source_0.set_params(int(self.Frequency), int(self.Bandwidth), 20000000, False, False, False, "manual", float(self.Gain1), '', True)
