...
class AudioTone(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AudioTone")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AudioTone")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AudioTone")
        ...
        self.connect((self.SourceA, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.SourceA, 0), (self.rational_resampler_xxx_0, 0))
...
def main(top_block_cls=AudioTone, options=None):
