...
class NsfMap60(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "NsfMap60")
        ...
        for c in range(6, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.radio_astro_vselect_0 = radio_astro.vselect(fftsize, int(fftsize/4), int(fftsize/2))
        ...
        self.radio_astra_vsum_0 = radio_astro.vsum(int(fftsize), int(fftsize/4), int(3*fftsize/4))
        ...
        self.qtgui_vector_sink_f_0_0_0.set_update_time(.5)
        ...
        self.qtgui_vector_sink_f_0_0_0.set_ref_level(.001)
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_0_0_win, 8, 2, 2, 6)
        for r in range(8, 10):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.radio_astra_vsum_0, 0), (self.qtgui_number_sink_0, 0))
        ...
        self.connect((self.radio_astro_vmedian_0_1, 0), (self.radio_astra_vsum_0, 0))
        self.connect((self.radio_astro_vmedian_0_1, 0), (self.radio_astro_ra_integrate_1, 0))
        self.connect((self.radio_astro_vmedian_0_1, 0), (self.radio_astro_vselect_0, 0))
        self.connect((self.radio_astro_vselect_0, 0), (self.qtgui_vector_sink_f_0_0_0, 0))
    ...
    def set_fftsize(self, fftsize):
        ...
        self._fftsize_save_config.write(open(self.ConfigFile, 'w'))
        self.set_xsteps([self.Bandwidth*1.E-6/self.fftsize, -self.Bandwidth*3.E5/(self.H1*self.fftsize), 1])
        self.radio_astra_vsum_0.set_c_begin(int(self.fftsize/4))
        self.radio_astra_vsum_0.set_c_end(int(3*self.fftsize/4))
        self.radio_astra_vsum_0.set_vlen(int(self.fftsize))
        ...
        self.radio_astro_vselect_0.set_vlen(self.fftsize)
        self.radio_astro_vselect_0.set_vec_begin(int(self.fftsize/4))
        self.radio_astro_vselect_0.set_vec_out_len(int(self.fftsize/2))
...
def main(top_block_cls=NsfMap60, options=None):
