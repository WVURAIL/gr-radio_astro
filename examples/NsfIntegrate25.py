...
class NsfIntegrate25(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radio_astro_ra_integrate_1 = radio_astro.ra_integrate(ObsName+".not", observers_save, fftsize, Frequencys, Bandwidths, Azimuth, Elevation, Record, obstype, 4096, units, 295., 10.)
