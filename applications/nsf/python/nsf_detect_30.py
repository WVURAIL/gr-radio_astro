...
class nsf_detect_30(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Nsf Airspy Mini 3 MHz Event detect", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_detect_30")
        ...
        for c in range(6, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.radio_astro_ra_event_sink_0 = radio_astro.ra_event_sink(ObsName+".not", fftsize, Frequency, Bandwidth, EventMode, 'Event Detection', Observer, Telescope, Device, float(Gain2), Azimuth, Elevation)
    ...
    def set_Gain2(self, Gain2):
        ...
        self.radio_astro_ra_event_sink_0.set_gain1(float(self.Gain2))
...
def main(top_block_cls=nsf_detect_30, options=None):
