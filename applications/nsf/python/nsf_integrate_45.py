...
class nsf_integrate_45(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_integrate_45")
        ...
        units = ['(s)', '', '', '', '',
            '', '', '', '', '']
        colors = [("gold", "black"), ("black", "black"), ("black", "black"), ("black", "black"), ("black", "black"),
    ...
    def get_Gain2_0(self):
        return self.Gain2_0

    def set_Gain2_0(self, Gain2_0):
        self.Gain2_0 = Gain2_0
...
def main(top_block_cls=nsf_integrate_45, options=None):
