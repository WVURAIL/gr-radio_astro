...
class nsf_detect_24(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Nsf RTLSDR Event Detect: 2.4MHz", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Nsf RTLSDR Event Detect: 2.4MHz")
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_detect_24")
...
def main(top_block_cls=nsf_detect_24, options=None):
