...
class nsf_integrate_100(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_integrate_100")
...
def main(top_block_cls=nsf_integrate_100, options=None):
