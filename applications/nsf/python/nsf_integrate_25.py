...
class nsf_integrate_25(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "NsfIntegrate: 2.5 MHz with Airspy", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_integrate_25")
        ...
        self.radio_astro_ra_ascii_sink_0 = radio_astro.ra_ascii_sink(ObsName+".not", observer, fftsize, Frequencys, Bandwidths, Azimuth, Elevation, Record, obstype, 4**5, nAve, telescope_save, device_save, Gain1, float(Gain2), float(Gain3))
...
def main(top_block_cls=nsf_integrate_25, options=None):
