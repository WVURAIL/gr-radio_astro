...
class nsf_integrate_60(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_integrate_60")
...
def main(top_block_cls=nsf_integrate_60, options=None):
