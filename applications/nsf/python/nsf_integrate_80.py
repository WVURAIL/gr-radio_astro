...
class nsf_integrate_80(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_integrate_80")
...
def main(top_block_cls=nsf_integrate_80, options=None):
