...
class nsf_detect_60(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Nsf Airspy Mini Event Detect: 6 MHz", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "nsf_detect_60")
...
def main(top_block_cls=nsf_detect_60, options=None):
