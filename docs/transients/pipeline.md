...
The dedispersed png files such as ![](../images/transients/simulations/dedispersed-pulsar-dm-100.png) show the pulsar after it has been dedispersed.

The dispersed files after this include the dispersed pulsar with noise and without noise. The without noise looks like a dispersed pulse train ![](../images/transients/simulations/dispersed-pulse-dm-400.png), while the train with noise looks like ![](../images/transients/simulations/dispersed-pulse-with-noise-dm-400.png).

The waterfall plots that have the diserpsed pulsar on look like ![](../images/transients/simulations/dispersed-pulsar-dm-600.png). This is what the pulsar looks like after the FFT and integration are done.

The dispersion measure files show the pulsar after it has been dediseprsed and the frequencies for each DM have been summed together. They look like ![](../images/transients/simulations/dispersion-measure-vs-time-dm-400-noisy.png) when noise is added to the signal. The bow ties are barely visible, which indicates this is on the upper end of where the pulse can be detected.


Finally, the SNR plots show the signal to noise ratio of each DM. a graph such as ![](../images/transients/simulations/snr-vs-dm-dm-200-noisy.png) shows that a pulsar has been identified between the range of DMs where the SNRis greater than ten.
...
![](../images/transients/pipeline/polyphase-filter-bank.png)
...
![](../images/transients/pipeline/fft-conjugate-integrate.png)
...
![](../images/transients/pipeline/throttle-to-matrix.png)
...
![](../images/transients/pipeline/dedisperse-block.png)
...
![](../images/transients/pipeline/pulse-detection.png)
...
* The frequencies are looked at to see which frequencies are without noise and within the bandpass. Note that the frequencies need to be looked at by hand if unsure what bandpass is or if there is significant noise.
 ...
 ![Total frequency plot](../images/transients/simulations/total-summed-frequency-20dm-pulse-sim.png)
...
![Power Spectrum](../images/transients/observations/power-spectrum-psr-b0329+54-prince-scope.png)

* The fft of the data is found to create a power spectrum

![Power Spectrum One DM](../images/transients/observations/power-spectrum-dm-20-psr-b0329+54-prince-scope.png)

* One DM's power spectrum is shown, and the pulse is easily visible

![Windowed Spectrum](../images/transients/observations/windowed-power-spectrum-psr-b0329+54-prince-scope.png)

* A tukey window is applied to the data in order to reduce the noise at the beginning of the plot

![Averaged Power](../images/transients/observations/averaged-power-over10-iterations-psr-b0329+54-prince-scope.png)

* The pulsar for a known period is summed over the period to produce an averaged pulse

![Iterated SNR](../images/transients/observations/snr-iterated-psr-b0329+54-prince-scope.png)
...
![Noise for Period Not Known](../images/transients/observations/hacked-noise-psr-b0329+54-prince-scope.png)
...
![Non period SNR](../images/transients/observations/snr-noperiod-psr-b0329+54-prince-scope.png)
...
![Total frequency plot DM=20](../images/transients/simulations/total-summed-frequency-20dm-pulse-sim.png)

![Total frequency plot DM=100](../images/transients/simulations/total-summed-frequency-100dm-pulse-sim.png)

![Total frequency plot DM=600](../images/transients/simulations/total-summed-frequency-600dm-pulse-sim.png)
...
![Power Spectrum DM=20](../images/transients/simulations/power-spectrum-20dm-pulse-sim.png)

![Power Spectrum DM=100](../images/transients/simulations/power-spectrum-100dm-pulse-sim.png)

![Power Spectrum DM=600](../images/transients/simulations/power-spectrum-600dm-pulse-sim.png)
...
![Power Spectrum One DM DM=20](../images/transients/simulations/power-spectrum-20dm-pulse-sim-one.png)

![Power Spectrum One DM DM=100](../images/transients/simulations/power-spectrum-100dm-pulse-sim-one.png)

![Power Spectrum One DM DM=600](../images/transients/simulations/power-spectrum-600dm-pulse-sim-one.png)

* The power spectrum for one specific DM is shown

![Windowed Spectrum DM=20](../images/transients/simulations/windowed-power-spectrum-20dm-pulse-sim.png)

![Windowed Spectrum DM=100](../images/transients/simulations/windowed-power-spectrum-100dm-pulse-sim.png)

![Windowed Spectrum DM=600](../images/transients/simulations/windowed-power-spectrum-600dm-pulse-sim.png)

* The tukey window is applied and again as we see, this resembles what was seen with the Princeton data for PSR B0329+54

![Averaged Power DM=20](../images/transients/simulations/averaged-power-over10-iterations-20dm-pulse-sim.png)

![Averaged Power DM=100](../images/transients/simulations/averaged-power-over10-iterations-100dm-pulse-sim.png)

![Averaged Power DM=600](../images/transients/simulations/averaged-power-over10-iterations-600dm-pulse-sim.png)
...
![Iterated SNR DM=20](../images/transients/simulations/snr-iterated-20dm-pulse-sim.png)

![Iterated SNR DM=100](../images/transients/simulations/snr-iterated-100dm-pulse-sim.png)

![Iterated SNR DM=600](../images/transients/simulations/snr-iterated-600dm-pulse-sim.png)
...
![Noise for Period Not Known DM=20](../images/transients/simulations/hacked-noise-20dm-pulse-sim.png)

![Noise for Period Not Known DM=100](../images/transients/simulations/hacked-noise-100dm-pulse-sim.png)

![Noise for Period Not Known DM=600](../images/transients/simulations/hacked-noise-600dm-pulse-sim.png)

* For the sake of obtuseness, assume that the period is not known, then the noise must be found in the same way as above.

![Noise for Period Not Known DM=20](../images/transients/simulations/snr-noperiod-20dm-pulse-sim.png)

![Noise for Period Not Known DM=100](../images/transients/simulations/snr-noperiod-100dm-pulse-sim.png)

![Noise for Period Not Known DM=600](../images/transients/simulations/snr-noperiod-600dm-pulse-sim.png)
